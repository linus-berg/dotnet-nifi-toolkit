...
namespace Nifi.Utils.Services
{
    public class FlowFileService : IFlowFileService
    {
        ...
        public async Task WriteFlowFileV3Async(NifiPackage package, Stream output_stream)
        {
        ...
        public async Task WriteFlowFileV1Async(NifiPackage package, Stream output_stream)
        {
